...
def seed_data():
    with app.app_context():
        ...
        # 3. Seed Rules
        # Malaria Rule: Fever, Chills, Sweating, Headache, Muscle Pain
        ...
        # Typhoid Rule: Fever, Abdominal Pain, Loss of Appetite, Weakness, Diarrhea
        ...
        # Co-infection Rule: Combination (simplified: overlapping symptoms)
        # For demonstration, if both malaria and typhoid symptoms are present
